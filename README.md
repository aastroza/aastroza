...
- **[November 2025]** 🇨🇱 Released [shiaaa.cl](https://shiaaa.cl/), a community-driven crowdsourcing platform to collect high-quality Chilean Spanish speech data. Current multilingual ASR models claim strong Spanish performance but fail badly on Chilean audio, so building an accurate model requires new data. [This platform](https://github.com/idsudd/shiaaa) lets anyone contribute transcripts that will be fully open-sourced along with the models trained on them.
